...
_Last updated: 2026-04-01 18:25_
...
- **Theme & Path Regression Fix**: Restored colored icons in light theme and fixed resource path resolution for Static/Tauri modes (supporting both `resources/` and `svgicons/`).
